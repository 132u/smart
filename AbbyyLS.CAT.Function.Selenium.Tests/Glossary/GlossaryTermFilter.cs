...
namespace AbbyyLS.CAT.Function.Selenium.Tests.Glossary
{
	public class GlossaryTermFilter<TWebDriverSettings> : BaseTest<TWebDriverSettings> where TWebDriverSettings : IWebDriverSettings, new()
	{
		...
		[Category("PRX_7565")]
		[Category("PRX_8781")]
		[TestCase("modified", "nextYear", "yearAgo", false, Explicit = true, Reason="Исключён в связи с багом PRX-7565")] // начальная дата изменения больше конечной
		[TestCase("created", "nextYear", "yearAgo", false, Explicit = true, Reason = "Исключён в связи с багом PRX-7565")] // начальная дата создания больше конечной
