...
namespace AbbyyLs.CAT.Function.Selenium.Tests
{
	...
	class GlossaryEditorTest : BaseTest
	{
		...
		public GlossaryEditorTest(string url, string workspaceUrl, string browserName)
        ...
        {
            _projectName2 = ConfigurationManager.AppSettings["ProjectName"] + "_" + DateTime.UtcNow.Ticks.ToString() + "2";
