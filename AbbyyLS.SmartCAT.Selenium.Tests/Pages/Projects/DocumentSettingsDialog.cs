...
namespace AbbyyLS.SmartCAT.Selenium.Tests.Pages.Projects
{
	public class DocumentSettingsDialog : ProjectsPage, IAbstractPage<DocumentSettingsDialog>
	{
		...
		protected const string GLOSSARY_CHECKBOX_BY_NAME = "//div[contains(@class,'document-settings')][3]//tbody[@data-bind='foreach: glossaries']//tr//span[text()='*#*']//ancestor::td//preceding-sibling::td//input";
		protected const string TM_CHECKBOX_BY_NAME = "//div[contains(@class,'document-settings')][3]//tbody[@data-bind = 'foreach: translationMemories']//tr//p[@title='*#*']/ancestor::td/following-sibling::td//input";
