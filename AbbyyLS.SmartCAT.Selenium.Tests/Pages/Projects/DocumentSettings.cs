...
namespace AbbyyLS.SmartCAT.Selenium.Tests.Pages.Projects
{
	public class DocumentSettings : ProjectsPage, IAbstractPage<DocumentSettings>
	{
		...
		protected const string MT_CHECKBOX = "//div[@class='g-popup-bd js-popup-bd js-popup-single-target-document-settings'][2]//tbody[contains(@data-bind, 'machineTranslators')]//span[text()='*#*']/../../preceding-sibling::td";
