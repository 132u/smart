...
namespace AbbyyLS.SmartCAT.Selenium.Tests.Tests.Projects
{
	...
	class DocumentFormatTests<TWebDriverProvider> : BaseTest<TWebDriverProvider> where TWebDriverProvider : IWebDriverProvider, new()
	{
		...
		[TestCase("odpFile.odp", Ignore = true, IgnoreReason = "PRX-11954")]
		...
		[TestCase("pptFile.ppt", Ignore = true, IgnoreReason = "PRX-11954")]
		...
		[TestCase("potxFile.potx", Ignore = true, IgnoreReason = "PRX-11954")]
		[TestCase("ppsFile.pps", Ignore = true, IgnoreReason = "PRX-11954")]
		[TestCase("ppsxFile.ppsx", Ignore = true, IgnoreReason = "PRX-11954")]
		[TestCase("pptxFile.pptx", Ignore = true, IgnoreReason = "PRX-11954")]
