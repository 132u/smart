...
using AbbyyLS.SmartCAT.Selenium.Tests.Tests.UsersRights.ManageGlossariesCompoundRights;

namespace AbbyyLS.SmartCAT.Selenium.Tests.Tests.UsersRights.ManageGlossaries.ManageGlossariesSpecificClient
{
